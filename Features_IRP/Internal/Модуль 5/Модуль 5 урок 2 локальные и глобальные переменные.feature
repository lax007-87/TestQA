...
Функционал: модуль 5 урок 2 локальные и глобальные переменные
...
Сценарий: модуль 5 урок 2 локальные переменные
...
Сценарий: модуль 5 урок 2 глобальные переменные		
	...
	// также для перезаписи можно использовать 4 знака $
	И я сохраняю навигационную ссылку текущего окна в переменную "$$$$СсылкаТоварБезХарактеристик$$$$"
